            ...
            <table class="w3-table-all" id="recipientsTable">
                ...
                {?>
                    <tr class="w3-hover-green">
                        ...
                        <td><a href="https://organdonorsystem.azurewebsites.net/Page_RecipientPatient.php?recipientID=<?=$recipient['PatientID']?>" id="<?= $recipient['PatientID']?>" class="w3-center"><?= $counter?>.</a></td>
